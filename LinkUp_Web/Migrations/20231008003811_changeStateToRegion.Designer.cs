...
namespace LinkUp_Web.Migrations
{
    ...
    [Migration("20231008003811_changeStateToRegion")]
    partial class changeStateToRegion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LinkUp_Web.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            productId = new Guid("c7f95dbd-6b37-423e-bb81-a8b846600b58"),
                            CategoryId = 1,
                            CompanyId = 1,
                            DisplayPrice = 110.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 13, 0, 38, 11, 543, DateTimeKind.Unspecified).AddTicks(2370), new TimeSpan(0, 0, 0, 0, 0)),
                            productHighlights = "Admin magic content",
                            productLocation = "AdminLocation",
                            productStartDate = new DateTimeOffset(new DateTime(2023, 10, 8, 0, 38, 11, 543, DateTimeKind.Unspecified).AddTicks(2370), new TimeSpan(0, 0, 0, 0, 0)),
                            productTitle = "AdminProduct",
                            supplierPrice = 100.0
                        },
                        new
                        {
                            productId = new Guid("0caa65f6-abac-4fd1-b782-5ae332a92000"),
                            CategoryId = 2,
                            CompanyId = 2,
                            DisplayPrice = 120.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 15, 0, 38, 11, 543, DateTimeKind.Unspecified).AddTicks(2370), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            productId = new Guid("555b1332-fb69-4b47-a427-7f848efca56f"),
                            CategoryId = 3,
                            CompanyId = 3,
                            DisplayPrice = 130.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 17, 0, 38, 11, 543, DateTimeKind.Unspecified).AddTicks(2370), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("LinkUp_Web.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "de9d6854-a02f-46a7-9b1f-95582fa9a816",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a49310d6-9281-4890-ad61-6538292751bb",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "13dc8ce7-c781-4f5e-aa58-e6ecd4c47779",
                        ...
                        new
                        {
                            Id = "c7419d8f-ab20-4753-9de9-1a31cb694049",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "59759186-b0d2-4181-83df-98df10f91bf4",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "91d6d702-33e9-4fa3-8e35-aa11299fc34a",
                            TwoFactorEnabled = false,
                            City = "Admin1City",
                            CompanyId = 2,
                            Gender = "Male",
                        ...
                        new
                        {
                            Id = "0ff8d8d7-aa07-47a2-9770-73d35e2dfa57",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9a035629-bd30-4451-8d1b-9400cf329111",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "705dc3a3-6d1e-4d28-9885-5491a254594e",
                            TwoFactorEnabled = false,
                            City = "Admin2City",
                            CompanyId = 1,
                            Gender = "Male",
