...
namespace LinkUp_Web.Migrations
{
    ...
    [Migration("20230927005049_adEverythingAgain")]
    partial class adEverythingAgain
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LinkUp_Web.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            productId = new Guid("d6a5ad25-df3d-4aad-9e21-84636254d221"),
                            CategoryId = 1,
                            CompanyId = 1,
                            DisplayPrice = 110.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 2, 0, 50, 49, 428, DateTimeKind.Unspecified).AddTicks(6820), new TimeSpan(0, 0, 0, 0, 0)),
                            productHighlights = "Admin magic content",
                            productLocation = "AdminLocation",
                            productStartDate = new DateTimeOffset(new DateTime(2023, 9, 27, 0, 50, 49, 428, DateTimeKind.Unspecified).AddTicks(6820), new TimeSpan(0, 0, 0, 0, 0)),
                            productTitle = "AdminProduct",
                            supplierPrice = 100.0
                        },
                        new
                        {
                            productId = new Guid("335048f1-8b64-4f53-ae23-42bd5c9e7c59"),
                            CategoryId = 2,
                            CompanyId = 2,
                            DisplayPrice = 120.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 4, 0, 50, 49, 428, DateTimeKind.Unspecified).AddTicks(6820), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            productId = new Guid("b39bab29-c994-4527-a1b4-5ce239d8e86a"),
                            CategoryId = 3,
                            CompanyId = 3,
                            DisplayPrice = 130.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 6, 0, 50, 49, 428, DateTimeKind.Unspecified).AddTicks(6820), new TimeSpan(0, 0, 0, 0, 0)),
