...
{
    /// <inheritdoc />
    public partial class adEverythingAgain : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    companyDateJoined = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    PhoneNumber = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    productStartDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    productEndDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    CompanyId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Companies",
                columns: new[] { "CompanyId", "Bio", "City", "Name", "PhoneNumber", "StreetAddress", "companyDateJoined" },
                values: new object[,]
                {
                    { 1, "AdminRegion", "AdminCity", "AdminCompany", "0550762466", "AdminStreet", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 2, "Admin1Region", "Admin1City", "Admin1Company", "0267067953", "Admin1Street", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) },
                    { 3, "Admin2Region", "Admin2City", "Admin2Company", "0550767953", "Admin2Street", new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) }
                });
