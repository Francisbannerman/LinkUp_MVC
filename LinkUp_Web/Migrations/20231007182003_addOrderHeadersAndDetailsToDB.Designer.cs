...
namespace LinkUp_Web.Migrations
{
    ...
    [Migration("20231007182003_addOrderHeadersAndDetailsToDB")]
            ...
            modelBuilder.Entity("LinkUp_Web.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            productId = new Guid("d0f164fc-8e2a-472a-a3f0-1c9d2df58aa5"),
                            CategoryId = 1,
                            CompanyId = 1,
                            DisplayPrice = 110.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 12, 18, 20, 3, 497, DateTimeKind.Unspecified).AddTicks(2100), new TimeSpan(0, 0, 0, 0, 0)),
                            productHighlights = "Admin magic content",
                            productLocation = "AdminLocation",
                            productStartDate = new DateTimeOffset(new DateTime(2023, 10, 7, 18, 20, 3, 497, DateTimeKind.Unspecified).AddTicks(2100), new TimeSpan(0, 0, 0, 0, 0)),
                            productTitle = "AdminProduct",
                            supplierPrice = 100.0
                        },
                        new
                        {
                            productId = new Guid("5d5b342c-c477-4d12-bab0-c59d9ba8b119"),
                            CategoryId = 2,
                            CompanyId = 2,
                            DisplayPrice = 120.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 14, 18, 20, 3, 497, DateTimeKind.Unspecified).AddTicks(2100), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            productId = new Guid("19318628-9983-4d50-bdd5-96b8bd115438"),
                            CategoryId = 3,
                            CompanyId = 3,
                            DisplayPrice = 130.0,
                            ...
                            productEndDate = new DateTimeOffset(new DateTime(2023, 10, 16, 18, 20, 3, 497, DateTimeKind.Unspecified).AddTicks(2100), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("LinkUp_Web.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "499412db-f8c2-4ead-b9f6-645a9dd50a9c",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "040c8cbe-658f-4970-b5ad-d74882119c0e",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "ed3b3e15-247d-416f-bbad-2a745f843816",
                        ...
                        new
                        {
                            Id = "2d989643-80b9-4a80-95a7-75e4dbdb200a",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "138d0e59-6c06-443e-bc54-56ea5ab43430",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "b2667d28-5285-4742-85db-f64da5d000e2",
                            TwoFactorEnabled = false,
                            City = "Admin1City",
                            CompanyId = 2,
                            Gender = "Male",
                        ...
                        new
                        {
                            Id = "a8257fab-f18b-4607-9783-dfeab0c8c9b3",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9fce77da-ac90-417b-bf6b-286417aedc20",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2a0d5f4b-c944-4c2d-b672-91b7aa949c07",
                            TwoFactorEnabled = false,
                            City = "Admin2City",
                            CompanyId = 1,
                            Gender = "Male",
